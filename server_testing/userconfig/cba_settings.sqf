...
force force ace_common_checkPBOsAction = 0; // testing only
...
force force ace_medical_playerDamageThreshold = 1; // unsynced main/training
force force ace_medical_spontaneousWakeUpChance = 0.05;
force force ace_medical_spontaneousWakeUpEpinephrineBoost = 1;
force force ace_medical_statemachine_AIUnconsciousness = true; // unsynced main/training
