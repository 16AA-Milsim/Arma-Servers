...
force force kat_airway_Accuvac_time = 7;
...
force force kat_breathing_medLvl_NasalCannula = 2;
...
force force kat_breathing_pneumothoraxChance = 10;
force force kat_breathing_pneumothoraxDamageThreshold = 0.45;
force force kat_breathing_pneumothoraxDamageThreshold_TakenDamage = true;
force force kat_breathing_PortableOxygenTank_RefillTime = 30;
force force kat_breathing_PulseOximeter_SpO2Warning = 90;
...
force force kat_breathing_Stable_spo2 = 88;
...
force force kat_circulation_AdvRhythm_AED_ROSC_Chance = 10;
...
force force kat_circulation_CPR_MinChance_Doctor = 5;
...
force force kat_circulation_medLvl_BPCuff = 1;
force force kat_circulation_medLvl_StethHR = 1;
force force kat_circulation_tamponadeChance = 0;
force force kat_circulation_treatmentTime_BPCuff = 4;
force force kat_circulation_treatmentTime_StethHR = 3;
...
force force kat_misc_treatmentTimeDetachTourniquet = 3;
...
force force kat_pharma_coagulation_allow_clot_text = false;
...
force force kat_pharma_treatmentTime_ApplyIO = 5;
force force kat_pharma_treatmentTime_ApplyIV = 7;
force force kat_pharma_treatmentTime_Atropine = 6;
force force kat_pharma_treatmentTime_Caffeine = 4;
force force kat_pharma_treatmentTime_Carbonate = 4;
force force kat_pharma_treatmentTime_CWMP = 4;
force force kat_pharma_treatmentTime_EACA = 6;
force force kat_pharma_treatmentTime_EpinephrineIV = 6;
force force kat_pharma_treatmentTime_Etomidate = 6;
force force kat_pharma_treatmentTime_Fentanyl = 6;
force force kat_pharma_treatmentTime_Flumazenil = 6;
...
force force kat_pharma_treatmentTime_Nalbuphine = 6;
...
force force kat_pharma_treatmentTime_Reorientation = 3;
...
force force kat_vitals_enableFluidShift = false;
...
force force kat_watch_watchInaccuracy = true;
