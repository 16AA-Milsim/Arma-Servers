...
force force ace_common_checkPBOsWhitelist = "['jsrs_soundmod_bullethits','jsrs_soundmod_explosions','jsrs_soundmod_complete_edition_soundfiles','jsrs_soundmod_complete_edition','MIRA_Vehicle_Medical','jsrs_soundmod_cfg_rhs_usf_vehicles','jsrs_soundmod_cfg_rhs_afrf_air_vehicles','jsrs_soundmod_weapons','blast_refract','jsrs_soundmod_rhs_gref_weapons','PLP_commonModData','jsrs_soundmod_framework','fxp_VehHeli','jsrs_soundmod_cfg_rhs_afrf_vehicles','fxp_VehTank','jsrs_soundmod_sonic_cracks','jsrs_soundmod_movement','jsrs_soundmod_rhs_usf_weapons','WarFXPE_Weps','Blastcore_VEP','PLP_hidePasswords','jsrs_soundmod_landvehicles','jsrs_soundmod_cfg_rhs_usf_weapons','jsrs_soundmod_cfg_rhs_usf_air_vehicles','jsrs_soundmod_boats','jsrs_soundmod_environment','fxp_adat','fxp_VehPlane','jsrs_soundmod_helicopters','fxp_VehExpEffect','Blastcore_MainCore','jsrs_soundmod_cfg_rhs_afrf_weapons','WarFXPE','fxp_VehExpEffectBig','Ca','jsrs_soundmod_16aa','A3TI','jsrs_soundmod_rhs_afrf_weapons','OCAP_main','OCAP_extension','OCAP_recorder','dedmen_arma_script_profiler','dedmen_sqf_assembly','Intercept_Core']";
...
force force ace_medical_statemachine_AIUnconsciousness = false; // unsynced main/training
