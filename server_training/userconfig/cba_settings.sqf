...
force force ace_common_checkPBOsWhitelist = "['Ca','jsrs_soundmod_complete_edition_soundfiles','fxp_adat','fxp_VehExpEffect','fxp_VehExpEffectBig','fxp_VehHeli','fxp_VehPlane','WarFXPE_Weps','fxp_VehTank','jsrs_soundmod_complete_edition','jsrs_soundmod_boats','jsrs_soundmod_sonic_cracks','jsrs_soundmod_weapons','jsrs_soundmod_environment','jsrs_soundmod_explosions','jsrs_soundmod_framework','jsrs_soundmod_landvehicles','jsrs_soundmod_movement','jsrs_soundmod_bullethits','jsrs_soundmod_helicopters','PLP_commonModData','PLP_hidePasswords','WarFXPE','Blastcore_MainCore','gaz_16AA_melb_sound','blast_refract','jsrs_soundmod_rhs_afrf_weapons','jsrs_soundmod_cfg_rhs_afrf_weapons','jsrs_soundmod_cfg_rhs_afrf_vehicles','jsrs_soundmod_cfg_rhs_afrf_air_vehicles','jsrs_soundmod_rhs_usf_weapons','jsrs_soundmod_cfg_rhs_usf_weapons','jsrs_soundmod_cfg_rhs_usf_vehicles','jsrs_soundmod_cfg_rhs_usf_air_vehicles','A3TI','Blastcore_VEP','jsrs_soundmod_rhs_gref_weapons','jsrs_soundmod_16aa','grcb_jsrs_cup_weapons','OCAP_main','OCAP_extension','OCAP_recorder','dedmen_arma_script_profiler','dedmen_sqf_assembly','Intercept_Core']";
